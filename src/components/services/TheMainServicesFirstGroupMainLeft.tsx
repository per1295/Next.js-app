...
import styles from "../../styles/services/TheMainServicesFirstGroupMainLeft.module.scss";
...
export default function TheMainServicesFirstGroupMainLeft() {
    ...
    return(
        <div className={styles.mainServices_firstGroup__main___left}>
            <Information appendedClassName={styles.mainServices_firstGroup__main___left_information}>
            ...
            <div className={styles.wrapCheckboxes}>
