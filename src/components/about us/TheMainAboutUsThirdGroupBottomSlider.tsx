import { useContext, useRef, useEffect, useState, PointerEventHandler } from "react";
import styles from "../../styles/about us/TheMainAboutUsThirdGroupBottomSlider.module.scss";
...
export default function TheMainAboutUsThirdGroupBottomSlider() {
    ...
    return(
        ...
        ref={sliderRef}
        className={styles.mainAboutUs_thirdGroup__bottom___slider}>
            {
